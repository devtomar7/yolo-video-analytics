...
REPORT_FILE = "output/analytics_report.csv"
...
# Crossing zone around the counting line
# Helps reduce false crossing detections
LINE_TOLERANCE = 30

# Classes to count
# Set to None if you want to count ALL YOLO classes
ALLOWED_CLASSES = {
    "person",
    "car",
    "motorcycle",
...
print(f"Line tolerance: {LINE_TOLERANCE}px")
...
while True:
    ...
    if result.boxes is not None:
        ...
        if result.boxes.id is not None:
            ...
            for track_id, class_id, confidence, box in zip(
                ...
                unique_class_ids[track_id] = class_name
                ...
                if center_x < line_x - LINE_TOLERANCE:

                    current_side = -1

                elif center_x > line_x + LINE_TOLERANCE:
                ...
                if track_id in object_sides:

                    previous_side = object_sides[track_id]
                ...
                if current_side != 0:
                    ...
                    object_sides[track_id] = current_side
    ...
    left_zone = line_x - LINE_TOLERANCE

    right_zone = line_x + LINE_TOLERANCE
...
try:
    ...
    print(
        f"WARNING: Could not save CSV report: {e}"
    )
